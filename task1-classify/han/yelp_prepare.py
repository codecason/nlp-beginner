...
def build_word_frequency_distribution():
  ...
  try:
    ...
    print('frequency distribution loaded {}'.format(IOError))
  ...
  print('building frequency distribution done')
  return freq
...
def build_vocabulary(lower=3, n=50000):
  try:
    ...
    print('building vocabulary error {}'.format(e))
...
def make_data(split_points=(0.8, 0.94)):
  ...
  try:
    ...
    print('make_data error {}'.format(KeyboardInterrupt))
