...
hyp_sentences: n_train * max_hypothesis_length * min(vector_size, embedding) (30, 50)
evi_sentences
...
fc_weight: (2 * H, 3)
rnn_outputs： 60 * 128 * 128 (2 H * 2 H)
fc_bias: 3
classification_scores: 2H * class
predicts: 2H
y_label: 128 * 1
cross_entropy: 128 * 1

hyps: batch * l_h * D
correct_scores: n_dev * class
